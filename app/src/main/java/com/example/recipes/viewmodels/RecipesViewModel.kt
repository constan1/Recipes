...
import com.example.recipes.util.Constants.Companion.DEFAULT_RECIPE_NUMBER
...
class RecipesViewModel @ViewModelInject constructor
    ...
    fun saveMealAndDietType(mealType: String, mealTypId: Int, dietType: String, dietTypeId: Int) =
            viewModelScope.launch(Dispatchers.IO) {
                dataStoreRepository.savedMealAndDietType(mealType, mealTypId, dietType, dietTypeId)
            }
